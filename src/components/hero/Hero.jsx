    ...
    <div className="hero">
      <div className="hSection left">
        ...
        <motion.div variants={awardVariants} initial="initial" animate="animate" className="awards">
          ...
          <motion.div variants={awardVariants} className="awardList">
            <motion.img variants={awardVariants} src="/award1.webp" alt="Award 1" loading="lazy" />
            <motion.img variants={awardVariants} src="/award2.webp" alt="Award 2" loading="lazy" />
            <motion.img variants={awardVariants} src="/award3.webp" alt="Award 3" loading="lazy" />
          </motion.div>
        </motion.div>
      ...
      <div className="hSection right">
        <motion.div variants={followVariants} initial="initial" animate="animate" className="follow">
          <motion.a variants={followVariants} href="https://www.linkedin.com/in/sherinann" target="_blank" rel="noopener noreferrer">
            <img src="/linkedIn.webp" alt="LinkedIn profile" loading="lazy" />
          </motion.a>
          <motion.a variants={followVariants} href="https://github.com/stwhello" target="_blank" rel="noopener noreferrer">
            <img src="/github.webp" alt="GitHub profile" loading="lazy" />
          </motion.a>
          <motion.a
            variants={followVariants}
            href="https://drive.google.com/file/d/18fiHWvAQe_4SnsK1atHoN5VvjUgjAY0z/view?usp=sharing"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img src="/resume.webp" alt="Resume" loading="lazy" />
          </motion.a>
        ...
        <motion.div animate={{ opacity: [0, 1] }} transition={{ duration: 1 }} className="certificate">
          <img src="/certificate.webp" alt="Certificate" loading="lazy" />
          VERSATILE DEVELOPER
          <br />
          AI - ENTHUSIAST
          <br />
